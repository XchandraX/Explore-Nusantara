class kuisSection extends HTMLElement {
  connectedCallback() {
    this.innerHTML = `
        ...
        <div
        class="relative w-full max-w-2xl flex justify-center items-center m-12">
        <img
            src="/public/img/indonesia-island.png"
            alt="Pulau Indonesia"
            class="rounded-lg shadow-lg w-72 z-0 relative" />
        <img
            src="/public/img/borobudur.png"
            alt="Borobudur"
            class="absolute -top-8 right-16 w-40 rounded-lg shadow-lg translate-x-10 -translate-y-6 z-0" />
        <img
            src="/public/img/temple-bali-indonesia.png"
            alt="Bali"
            class="absolute -bottom-8 right-12 w-40 rounded-lg shadow-lg translate-x-6 translate-y-8 z-20" />
        </div>
